/**
 * HTTP adapter for the Progress module.
 *
 * Reads the request, calls progressService, shapes the reply with the helpers
 ...
 *     const item = await progressService.getById(request.params.id);
