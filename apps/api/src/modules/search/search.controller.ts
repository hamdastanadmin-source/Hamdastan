/**
 * HTTP adapter for the Search module.
 *
 * Reads the request, calls searchService, shapes the reply with the helpers
 ...
 *     const item = await searchService.getById(request.params.id);
