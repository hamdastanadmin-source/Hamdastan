...
import type { IconName } from '@hamdastan/ui';
import { SectionHeader } from '@hamdastan/ui';
import {
                    ...
                    <div ref={el => { sectionRefs.current['display'] = el; }} className="space-y-8">
                        ...
                        <ShowcaseSection title="Avatar">
                            <div className="flex flex-wrap items-center gap-4">
                                ...
                                {/* No avatar has been added to public/images/avatars yet, so this
                                    one demonstrates the fallback path rather than the image path. */}
