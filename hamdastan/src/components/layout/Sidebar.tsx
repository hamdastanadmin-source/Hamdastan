        ...
        <>
            ...
            >
                <div className="h-14 shrink-0 flex items-center justify-center px-5 border-b border-border">
                    <Link href="/">
                        {isCollapsed ? (
                            <Image src="/logo.svg" alt="Logo" width={32} height={32} className="h-8 w-8 object-contain" priority />
                        ) : (
                            <Image src="/logo.svg" alt="Logo" width={120} height={40} className="h-8 w-auto" priority />
                        )}
                    </Link>
                </div>
